...
const groups: Record<string, SettingDefinition[]> = {
	...
	'note-settings': [
		...
		{ kind: 'boolean', key: 'longNoteFadeEnabled', label: 'ロングトーンFade' },
	...
	'long-note-dissolve-settings': [
		{ kind: 'boolean', key: 'showLongNoteDissolve', label: 'ロングトーン粒子化' },
		{ kind: 'number', key: 'longNoteDissolveTimingPercent', label: '粒子化タイミング (%)', min: 10, max: 90, step: 5 },
		{ kind: 'number', key: 'longNoteDissolvePreFlashSeconds', label: '粒子化前に発光 (秒)', min: 0, max: 0.5, step: 0.05 },
