...
- 実Fade時間の前半は、ノート本体とGlowを通常どおり線形Fadeする。
- 50%地点でノート本体とGlowを非表示にし、同じTrack色の粒子へ置き換える。
- 後半50%は粒子をXY方向へ大きく、Z方向へ控えめに拡散する。
...
| 拡散リング | `public/assets/ring.png` | 発音平面に沿って広がりながら消失 |
